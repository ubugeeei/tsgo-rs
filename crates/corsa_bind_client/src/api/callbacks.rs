...
use corsa_bind_core::fast::{Bump, BumpString, CompactString, SmallVec, compact_format};
use phf::phf_map;
...
///
/// ```
/// use corsa_bind_client::{ApiFileSystem, FileSystemCapabilities, callback_names};
///
/// struct Fs;
///
...
///
/// ```
/// use corsa_bind_client::{ApiFileSystem, FileSystemCapabilities, callback_flag};
///
/// struct Fs;
///
/// impl ApiFileSystem for Fs {
